...
public class EventSpecification {
    ...
    public static Specification<EventModel> findByTheme(String theme) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.like(root.get("theme"), "%" + theme + "%");
    }

    public static Specification<EventModel> findByOrganizer(String organizer) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.like(root.get("organizer"), "%" + organizer + "%");
    }
